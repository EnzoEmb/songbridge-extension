...
function render(data) {
  ...
  currentlyPlayingDiv.innerHTML = `
    ...
    data.artist
      ...
      <div class="links">
        <a class="spotify" href="#"  title="Go to Spotify">
        ...
        <a class="youtube-music" href="#" title="Go to YouTube Music">
        ...
        <a class="youtube" href="#" title="Go to YouTube">
        ...
        <a class="apple" href="#" title="Go to Apple Music">
        ...
        <a class="deezer" href="#" title="Go to Deezer">
        ...
        <a class="soundcloud" href="#" title="Go to SoundCloud">
        ...
        <a class="amazon-music" href="#" title="Go to Amazon Music">
        ...
        <a class="tidal" href="#" title="Go to TIDAL">
        ...
        <a class="odesli" href="#" title="Go to Odesli">
